...
(function(window, document, BytePushers) {
  ...
  BytePushers.implementsInterface = function (o /*, ... */) {
    for(var i = 1; i < arguments.length; i++) { // for each argument after o var arg = arguments[i];
      switch(typeof arg) { // If arg is a:
        ...
        case 'object': // object: check for matching methods for(var m in arg) { // For each property of the object
